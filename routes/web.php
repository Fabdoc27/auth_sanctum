...
Route::view( '/resetPassword', 'pages.auth.resetPassword' )->middleware( 'auth:sanctum' );
Route::view( '/userProfile', 'pages.dashboard.profile' )->name( 'profile.page' )->middleware( 'auth:sanctum' );
